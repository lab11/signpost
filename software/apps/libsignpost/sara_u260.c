...
static int sara_u260_write_to_file(const char* fname, uint8_t* buf, size_t len) {
    ...
    char c[50];
    int clen = sprintf(c, "AT+UDWNFILE=\"%s\",%d\n", fname, len);
